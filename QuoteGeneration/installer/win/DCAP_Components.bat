...
copy /y "%QGFOLDER%\qpl\inc\sgx_default_quote_provider.h" "%pwd%\Header Files\sgx_default_quote_provider.h"
...
copy /y "%DEBUGFILEFOLDER%\dcap_quoteprov.lib" "%pwd%\lib\native\Debug Support\dcap_quoteprov.lib"
...
copy /y "%RELEASEFILEFOLDER%\dcap_quoteprov.lib" "%pwd%\lib\native\Libraries\dcap_quoteprov.lib"
